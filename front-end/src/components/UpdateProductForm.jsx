...
function UpdateProductForm({
  ...
  return (
    <div className="fixed top-0 left-0 h-full w-full bg-gray-800 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white dark:bg-slate-800  border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg p-6 relative max-h-full overflow-y-auto">
        <button
        ...
        <div className="max-w-md mx-auto p-6 bbg-white dark:bg-slate-800   dark:border-slate-700 shadow-md">
              ...
              {product.colors.map((colorObj, index) => (
                <div key={index} className="col-span-2">
                  ...
                  <input
                    ...
                    className="mt-1 text-gray-700 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    required
                  />
                  {["S", "M", "L", "XL"].map((size) => (
                    <div key={size}>
                      ...
                      <input
                        ...
                        className="mt-1 block w-full text-gray-700 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        required
                      />
                      <label className="block text-sm font-medium ">
                        Size {size} sold:
